...
{
    public partial class added_discussionAndCommentEntities : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Discussions_Films_FilmId",
                        column: x => x.FilmId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Discussions_CreatedUserId",
                table: "Discussions",
                column: "CreatedUserId");

            migrationBuilder.CreateIndex(
                name: "IX_Discussions_FilmId",
                table: "Discussions",
                column: "FilmId");
        }
